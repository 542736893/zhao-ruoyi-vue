...
public interface UserResourceMapper {
     ...
     * @return 用户资源关联对象
     */
    UserResource selectUserResourceByUserIdAndResourceId(@Param("userId") Long userId, @Param("resourceId") Long resourceId);
     ...
     * @return 结果
     */
    int deleteUserResourceByUserIdAndResourceId(@Param("userId") Long userId, @Param("resourceId") Long resourceId);
